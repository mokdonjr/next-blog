...
lastUpdatedAt: 2024-03-31T00:00:00.000
---
...
1. 다수 게임 (일곱개의대죄, 세븐나이츠2, 에이지오브타이탄, 아이언쓰론 및 다수 신작에 사용) 적용 성공하여 CCU (동시접속) 30만 달성.
...
6. SaaS 이용 프로젝트별 요구사항 충족을 위한 프로젝트 설정 지속적 추가하고 개발을 넘어 문서화/프레젠테이션 까지 진행.
